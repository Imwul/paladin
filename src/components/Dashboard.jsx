    ...
    <div className="cs-page view-animate">
      ...
      <div className="cs-row" style={{ marginTop: '12px' }}>
        ...
        <section className="cs-section">
          <div className="sheet-ribbon"><h3><BookOpen size={16} style={{ marginRight: '6px' }} />빠른 시작 가이드</h3></div>
          <div className="cs-section-inner">
            <ol style={{ paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '1rem' }}>
              <li><strong>기사 시트</strong> 탭으로 이동하여 캐릭터를 생성합니다. 능력치를 입력하면 파생 스탯이 자동 계산됩니다!</li>
        ...
        {/* Chivalric Code Card */}
        <section className="cs-section">
          <div className="sheet-ribbon"><h3><Award size={16} style={{ marginRight: '6px' }} />기사도 십계명</h3></div>
          <div className="cs-section-inner">
            <p style={{ fontStyle: 'italic', color: 'var(--color-ink-light)', marginBottom: '12px', fontSize: '0.95rem' }}>
              진정한 성기사는 명예와 신앙을 수호해야 합니다. 다음 대립 성향들을 갈고닦아 보너스를 획득하세요:
            </p>
            <ul style={{ listStyleType: 'square', paddingLeft: '20px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px', fontSize: '0.95rem' }}>
      ...
      <section className="cs-section" style={{ marginTop: '4px' }}>
        <div className="sheet-ribbon"><h3><Compass size={16} style={{ marginRight: '6px' }} />핵심 게임 시스템</h3></div>
        <div className="cs-section-inner">
          <div className="cs-row" style={{ gap: '20px' }}>
            <div style={{ flex: '1 1 250px', minWidth: 0 }}>
              <h4 style={{ color: 'var(--color-crimson)', marginBottom: '6px', fontWeight: 700, fontSize: '1rem' }}>행동 판정 (d20)</h4>
              <ul style={{ paddingLeft: '15px', display: 'flex', flexDirection: 'column', gap: '4px', fontSize: '0.9rem', color: 'var(--color-ink-light)' }}>
            ...
            <div style={{ flex: '1 1 250px', minWidth: 0 }}>
              <h4 style={{ color: 'var(--color-crimson)', marginBottom: '6px', fontWeight: 700, fontSize: '1rem' }}>대립 성향</h4>
              <p style={{ fontSize: '0.9rem', color: 'var(--color-ink-light)' }}>
                13쌍의 대립 성향의 합은 <strong>언제나 20</strong>. 정숙을 12로 올리면 음탕은 자동으로 8이 됩니다.
              </p>
            </div>
            <div style={{ flex: '1 1 250px', minWidth: 0 }}>
              <h4 style={{ color: 'var(--color-crimson)', marginBottom: '6px', fontWeight: 700, fontSize: '1rem' }}>기사도 보너스</h4>
              <p style={{ fontSize: '0.9rem', color: 'var(--color-ink-light)' }}>
