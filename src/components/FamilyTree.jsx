...
import { Heart, Plus, Trash2, Edit, Crown, UserPlus, X, RefreshCw, Info, Calendar, Skull, Dices, Check, Shield, Award, ChevronLeft, ChevronRight, Sparkles, RotateCcw } from 'lucide-react';
    ...
    <div className="ft-container view-animate">
      ...
      <div className="ft-panels-stack" style={{ margin: '12px 0 16px 0', display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        <div className="ft-panel" style={{ border: '1px solid var(--color-gold-light)', borderRadius: '8px', backgroundColor: 'rgba(255, 255, 255, 0.45)', overflow: 'hidden', boxShadow: 'var(--shadow-medieval)' }}>
          ...
          >
            <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}><Shield size={14} /> 🏰 가문 명망 및 영지 설정</span>
            <span style={{ fontSize: '0.8rem' }}>{activePanel === 'settings' ? '접기 ▲' : '펼치기 ▼'}</span>
          </div>
