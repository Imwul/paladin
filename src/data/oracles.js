...
export const rollGrades = {
  CRITICAL: {
    title: "대성공",
    desc: "주사위 결과가 수정된 기술/성향 수치와 정확히 일치했습니다.\n기술 판정은 특별한 성과를 내며, 전투 무기 판정은 최대 피해를 줍니다.",
    color: "#2e7d32"
  },
  SUCCESS: {
    title: "성공",
    desc: "주사위 결과가 수정된 기술/성향 수치보다 낮습니다.\n의도한 행동에 성공했습니다.",
    color: "#1b5e20"
  },
  FAILURE: {
    title: "실패",
  ...
  FUMBLE: {
    title: "대실패",
    desc: "수치가 20 미만일 때 주사위 20이 나왔습니다.\n판정 종류에 따른 대실패 결과를 적용합니다.",
    color: "#992222"
  }
};
