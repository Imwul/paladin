...
export const rollGrades = {
  CRITICAL: {
    title: "대성공",
    desc: "주사위 눈이 기술/성향 점수와 완벽히 일치하거나 1이 나왔습니다.\n극적인 대성공을 거두며, 전투 중이라면 피해량이 2배가 됩니다.",
    color: "#2e7d32"
  },
  SUCCESS: {
    title: "성공",
    desc: "주사위 눈이 기술/성향 점수보다 작게 나왔습니다.\n의도한 행동을 안전하고 완벽하게 완수해냅니다.",
    color: "#1b5e20"
  },
  FAILURE: {
    title: "실패",
    desc: "주사위 눈이 기술/성향 점수보다 크게 나왔습니다.\n목표를 이루지 못했으나, 치명적인 재앙은 피했습니다.",
    color: "#6b665f"
  },
  FUMBLE: {
    title: "대실패",
    desc: "주사위 눈이 자연수 20이 나왔습니다.\n도구 파손, 마상 낙마, 극심한 사회적 망신 등 뼈아픈 악재를 겪습니다.",
    color: "#992222"
  }
};
