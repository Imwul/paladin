...
1. Chapter 7 고급·다수·원거리 전투와 일반 DEX 행동
2. Chapter 8 대규모 전투 전체 라운드와 공성
3. Chapter 12 거래·몸값·대출·마법 물품 효과
4. Chapter 17 외국 문화 캐릭터 생성
5. Chapter 18 적·생물 특수능력 실행
6. Chapter 19 모험 종단 실행
