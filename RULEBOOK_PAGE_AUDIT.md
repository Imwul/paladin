...
- 재검토일: 2026-08-09 (Chapter 7·8 재감사)
...
완전한 규칙서 등가물로 판정하지 않습니다. Chapter 7 개인 전투와 Chapter 8 소규모 교전·대규모 전투·공성은 종단 실행할 수 있지만, 부와 거래, 외국 문화 생성, 적·생물 실행, Chapter 19 완전 모험은 출시 차단 범위입니다. 겨울은 원문 순서 전체를 실행하지만 GM 판단이 필요한 결과는 명시적 미결 상태로 남깁니다.
