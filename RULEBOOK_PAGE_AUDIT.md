...
| 116 | 115 | Chapter Seven: Combat | **부분** · 전투·회복 장부와 규칙 엔진 제공 | 이동 위치·다수 상대·원거리 | 표준 1대1 교전은 종단 실행 |
| 117 | 116 | Chapter Seven: Combat | **부분** · 결정부터 이동까지 5단계와 대립 판정·피해 처리 | 이동 위치 상태 | 라운드 기록 영속화 |
| 118 | 117 | T | **구현** · 피해·갑옷·방패·피해 주사위 | 없음 | 승패 결과에서 단일 파이프라인 적용 |
| 119 | 118 | Chapter Seven: Combat | **구현** · 넘어짐·갑옷·방패·DEX 균형 | 일반 DEX 행동 | 낙마 1d6 별도 상처 포함 |
| 120 | 119 | Table 7–1: Encumbrance | **부분** · 무부하·부상·상황 수정을 전투 목표치에 적용 가능 | 중량 자동 분류·등반·도약 | GM 상황 수정은 명시 입력 |
| 121 | 120 | Chapter Seven: Combat | **부분** · 행동 선언과 이동 단계 표시 | 이동 거리·위치 추적 | 원문 행동 목록은 라운드 문맥으로 유지 |
| 122 | 121 | C | **부분** · 상처·기마·돌격·대기병·전술 수정 자동 적용 | 엄폐·시야·협소 공간 자동 감지 | 상황 수정 입력 제공 |
| 123 | 122 | Chapter Seven: Combat | **부분** · 마상창 돌격과 기마 대 보병 수정 | 말 HP·DEX·마갑 | 돌격 시 말 피해 주사위 사용 |
| 124 | 123 | Mounted Combat | **부분** · 말 종류 피해·대기병 예외·낙마 처리 | 말 자체 상처·기수 없는 말 | 핵심 기마 공격 실행 가능 |
| 125 | 124 | Chapter Seven: Combat | **부분** · 무기 프로필·비살상 피해·파손 결과 | 갑옷·방패 내구 원장·마상창 시합 | 무기별 피해 보정 구현 |
| 126 | 125 | Special Rules for Melee Combat | **부분** · 비살상·방패 밀치기·양손 무기 | 다수 상대·마상창 시합 | 선택 규칙과 본 규칙 분리 |
| 127 | 126 | Chapter Seven: Combat | **부분** · 방어·회피·이중 페인트 | 원거리 속사·조준·날씨 | 원거리 전투는 미완 |
| 128 | 127 | 2. Re-arm with a Dagger: He may rearm with a dagger | **부분** · 이탈 전술 | 그래플 전 과정 | 선택 규칙은 화면에서 명시 |
| 129 | 128 | Chapter Seven: Combat | **부분** · 맨손·전투 도리깨 자상 | 그래플·무제어 공격 | 미완 전술을 구현 완료로 표시하지 않음 |
